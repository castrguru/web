...
const footerNavigation = {
    ...
    links: [
        { name: "Our Docs", href: "https://castrgurudocs.on-fleek.app/" },
        { name: "Our Guides", href: "guides" },
        { name: "About Us", href: "about" },
    ],
    farcaster: [
        { name: "Homepage", href: "https://www.farcaster.xyz/" },
        { name: "Docs", href: "https://docs.farcaster.xyz/" },
...
const navigation = [
    ...
    { name: 'Facebook', href: '/', icon: (props: Prop) => (
    <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
        <path
            fillRule="evenodd"
    ...
    { name: 'Instagram', href: '/', icon: (props: Prop) => (
    <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
        <path
            fillRule="evenodd"
    ...
    { name: 'YouTube', href: '/', icon: (props: Prop) => (
    <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
        <path
            fillRule="evenodd"
            ...
            <div className="mx-auto max-w-7xl px-6 py-16 sm:py-24 lg:px-8 lg:py-32">
                <div className="xl:grid xl:grid-cols-3 xl:gap-8">
                    <div>
                        ...
                        <p className="py-10 text-sm/7 font-light text-fuchsia-300/70 tracking-widest">
                ...
                <p className="mt-8 text-center text-sm/6 text-gray-400 md:order-1">
