    ...
    return (
      ...
      */}
            <div>
                ...
                <div className="hidden mt-[85px] xl:fixed xl:inset-y-0 xl:z-50 xl:flex xl:w-72 xl:flex-col">
                    {/* Sidebar component, swap this element with another sidebar if you like */}
                ...
                <div className="xl:pl-72 bg-stone-900">
                        ...
                        <div className="divide-y divide-white/5">
                            ...
                            <div className="grid max-w-7xl grid-cols-1 gap-x-8 gap-y-10 px-4 py-16 sm:px-6 md:grid-cols-3 lg:px-8">
                                <div>
                                    ...
                                    <p className="mt-1 text-sm/6 text-gray-400">Please enter your password to confirm you would like to log out of your other sessions across all of your devices.</p>
                                </div>
