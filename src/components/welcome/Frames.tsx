...
export default function Frames() {
    return (
        <div className="bg-gradient-to-b from-stone-50 to-stone-200">
            <main>
                        ...
                        <div className="mx-auto max-w-7xl px-6 lg:px-8 py-24">
                            <div className="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none">
                                ...
                                <div className="mt-14 flex justify-end gap-8 sm:-mt-44 sm:justify-start sm:pl-20 lg:mt-0 lg:pl-0">
                                    <div className="ml-auto w-44 flex-none space-y-8 pt-16 sm:ml-0 sm:pt-32 lg:order-last lg:pt-36 xl:order-none">
                                    ...
                                    <div className="mr-auto w-44 flex-none space-y-8 sm:mr-0 sm:pt-4 lg:pt-8">
                                        <div className="relative">
                                            <img
                                                alt=""
