...
export default function RootLayout({
    ...
    const navigation = [
        { name: 'Dashboard', href: '/cloud', icon: TableCellsIcon, current: (pathname === '/cloud/') ? true : false },
        { name: 'Frames', href: '/cloud/frames', icon: RectangleGroupIcon, current: (pathname === '/cloud/frames/') ? true : false },
        { name: 'Community', href: '/cloud/community', icon: UsersIcon, current: (pathname === '/cloud/community/') ? true : false },
        { name: 'Monetize', href: '/cloud/monetize', icon: ReceiptPercentIcon, current: (pathname === '/cloud/monetize/') ? true : false },
        { name: 'Analytics', href: '/cloud', icon: PresentationChartLineIcon, current: (pathname === '/cloud/stats/') ? true : false },
        { name: 'Inspector', href: '/cloud/inspector', icon: LightBulbIcon, current: (pathname === '/cloud/inspector/') ? true : false },
        // { name: 'Security', href: '/cloud', icon: ShieldCheckIcon, current: (pathname === '/cloud/security/') ? true : false },
        // { name: 'Reports', href: '/cloud', icon: ChartPieIcon, current: (pathname === '/cloud/reports/') ? true : false },
    ]
        ...
        <html lang="en">
            ...
            <Dialog open={sidebarOpen} onClose={setSidebarOpen} className="relative z-50 lg:hidden">
                ...
                <div className="lg:pl-72">
                    ...
                    <main className="-mt-16 pt-16 min-h-screen flex flex-col justify-between bg-gradient-to-b from-stone-900 to-stone-700">
                        {children}
                        <FooterMin />
                    </main>
                </div>
